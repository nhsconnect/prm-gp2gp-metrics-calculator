                ...
                metrics=[
                    MonthlyMetricsPresentation(
                        ...
                        requested_transfers=RequestedTransferMetrics(
                            ...
                            integrated_within_8_days_count=0,
                            received_percent_of_requested=0,
                            integrated_within_3_days_percent_of_received=0,
                            integrated_within_8_days_percent_of_received=0,
                            not_integrated_within_8_days_total=0,
                            not_integrated_within_8_days_percent_of_received=0,
                            failures_total_count=0,
                            failures_total_percent_of_requested=0,
                            # deprecated fields
                            integrated_count=0,
                ...
                metrics=[
                    MonthlyMetricsPresentation(
                        ...
                        requested_transfers=RequestedTransferMetrics(
                            ...
                            integrated_within_3_days_count=1,
                            integrated_within_8_days_count=0,
                            received_percent_of_requested=66.67,
                            integrated_within_3_days_percent_of_received=50.00,
                            integrated_within_8_days_percent_of_received=0,
                            not_integrated_within_8_days_total=1,
                            not_integrated_within_8_days_percent_of_received=50.00,
                            failures_total_count=1,
                            failures_total_percent_of_requested=33.33,
                            # deprecated fields
                            integrated_count=1,
                            integrated_beyond_8_days_count=0,
                            awaiting_integration_count=1,
                ...
                metrics=[
                    MonthlyMetricsPresentation(
                        ...
                        requested_transfers=RequestedTransferMetrics(
                            ...
                            integrated_within_8_days_count=0,
                            received_percent_of_requested=100.00,
                            integrated_within_3_days_percent_of_received=40.00,
                            integrated_within_8_days_percent_of_received=0,
                            not_integrated_within_8_days_total=3,
                            not_integrated_within_8_days_percent_of_received=60.00,
                            failures_total_count=0,
                            failures_total_percent_of_requested=0,
                            # deprecated fields
                            integrated_count=2,
