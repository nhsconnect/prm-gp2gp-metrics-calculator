from prmcalculator.domain.practice.construct_practice_summary_v6 import (
    ...
    TransfersRequestedPresentation,
)
...
def test_returns_requester_transfers_requested():
    ...
    practice_details = build_practice_details()
    expected_requester_transfers_requested = TransfersRequestedPresentation(
        count=3,
    )
    ...
    actual_requester_transfers_requested = actual.metrics[0].requester.transfers_requested

    assert actual_requester_transfers_requested == expected_requester_transfers_requested
