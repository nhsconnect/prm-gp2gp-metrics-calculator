...
def test_resolver_returns_correct_transfer_data_uris():
    ...
    expected = [
        f"s3://{transfer_data_bucket}/v5/2021/11/transfers.parquet",
        f"s3://{transfer_data_bucket}/v5/2021/12/transfers.parquet",
        f"s3://{transfer_data_bucket}/v5/2022/1/transfers.parquet",
    ]
